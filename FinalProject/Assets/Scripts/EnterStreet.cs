...
{
    public Transform enterStreetPopup; // EnterGarage 팝업 UI 오브젝트

    private bool isInsideStreetZone = false; // 차량이 GarageZone에 있는지 여부
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        if (other.CompareTag("Player"))
        {
            ...
            ShowPopup(enterStreetPopup); // EnterGarage 팝업 활성화
