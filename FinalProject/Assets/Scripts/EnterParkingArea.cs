...
{
    public Transform enterParkingAreaPopup; // EnterGarage 팝업 UI 오브젝트

    private bool isInsideParkingAreaZone = false; // 차량이 GarageZone에 있는지 여부
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        if (other.CompareTag("Player"))
        {
            ...
            ShowPopup(enterParkingAreaPopup); // EnterGarage 팝업 활성화
